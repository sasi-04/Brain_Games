...
import './NumberShuffle.css';

const NumberShuffle = ({ onComplete, soundEnabled }) => {
    ...
    return (
      <div className="game-start-screen">
        <motion.div className="game-start-card" initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
          ...
          <button className="btn-secondary" onClick={() => onComplete({ game: 'Number Shuffle', score: 0, iq: 0, time: 0, action: 'back' })}>
            ← Back to Games
          </button>
        </motion.div>
      </div>
  ...
  return (
    <div className="numbershuffle-container">
      <div className="game-header">
          <button className="back-btn" onClick={() => onComplete({ game: 'Number Shuffle', score: 0, iq: 0, time: 0, action: 'back' })}>
          ← Back
        </button>
